...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::table('feedback', function (Blueprint $table) {
            ...
            if (!Schema::hasIndex('feedback', ['user_id', 'action', 'confidence'])) {
            ...
            if (!Schema::hasIndex('feedback', ['created_at', 'action'])) {
            ...
            if (!Schema::hasIndex('feedback', ['signal_type', 'confidence'])) {
        ...
        Schema::table('embeddings', function (Blueprint $table) {
            ...
            if (!Schema::hasIndex('embeddings', ['model', 'dimensions'])) {
            ...
            if (!Schema::hasIndex('embeddings', ['content_type', 'created_at'])) {
        ...
        Schema::table('inputs', function (Blueprint $table) {
            ...
            if (!Schema::hasIndex('inputs', ['type', 'source', 'created_at'])) {
        ...
        Schema::table('outputs', function (Blueprint $table) {
            ...
            if (!Schema::hasIndex('outputs', ['quality_score', 'feedback_integrated'])) {
            ...
            if (!Schema::hasIndex('outputs', ['parent_output_id', 'version'])) {
            ...
            if (!Schema::hasIndex('outputs', ['ai_model', 'quality_score', 'created_at'])) {
